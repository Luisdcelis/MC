...
public class Practica{
    ...
    public static parallelTumoralGrowth pTG;
    ...
    public class Dibujo2D extends JPanel{
        ...
        public void pintar()
        {
            for(int i = 0;i<pTG.celulas.length;++i)
            {
                for(int j = 0;j<pTG.celulas.length;++j)
                {
                    if(pTG.celulas[i][j][1].state == 1)
    ...
    private void mostrar(){
        ...
        JFrame ventana = new JFrame("Automata Celular");
...
//        dp.add(intF3);
        ...
        JTextField JTps = new JTextField("1.0", 10);
        c.gridx = 2;
        c.gridy = 4;
        c.gridwidth = 2;
        c.gridheight = 1;
        ...
        JTextField JTpp = new JTextField("0.25", 10);
        c.gridx = 2;
        c.gridy = 5;
        c.gridwidth = 2;
        c.gridheight = 1;
        ...
        JTextField JTpm = new JTextField("0.2", 10);
        c.gridx = 2;
        c.gridy = 6;
        c.gridwidth = 2;
        c.gridheight = 1;
        ...
        JTextField JTnp = new JTextField("2", 10);
        c.gridx = 2;
        c.gridy = 7;
        c.gridwidth = 2;
        c.gridheight = 1;
        ...
        String[] cad = { "varias células aleatorias", "una célula en el centro"};
        
        JComboBox<String> JCpos = new JComboBox<String>(cad);
        ...
        JLabel JLpos = new JLabel("Posición inicial: ");
        c.gridx = 1;
        c.gridy = 8;
        c.gridwidth = 2;
        c.gridheight = 1;
        ...
        dibu.addActionListener((ActionEvent e) -> {
            ...
            double Psurv = Double.parseDouble(JTps.getText());
            double Pprol = Double.parseDouble(JTpp.getText());
            double Pmigr = Double.parseDouble(JTpm.getText());
            int inputNP = Integer.parseInt(JTnp.getText());
            int posit = JCpos.getSelectedIndex();
            boolean po = (posit != 0);
            pTG = new parallelTumoralGrowth(tamano, Psurv, Pmigr, Pprol, inputNP, po);
            try {
